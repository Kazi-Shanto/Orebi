...
import blackWatch from '../assets/blackWatch.jpg'
                ...
                <div className='flex items-center gap-x-10'>
                    <div onClick={handleAcc} className='relative'>
                        ...
                        </svg>
                        {
                            ...
                            showAcc &&
                            <div className='absolute top-[27px] right-0 z-10 w-[200px]'>
                                <div>
                                    <button className='bg-black text-white font-dm text-sm font-bond px-[59px] py-4'>My Account</button>
                                </div>
                                <div>
                                    <button className='bg-white text-black font-dm text-sm font-bond px-[73px] py-4'>Log Out</button>
                                </div>
                            </div>
                        }
                    ...
                    <div onClick={handleCart} className='relative'>
                        ...
                        </svg>
                        {
                            ...
                            showCart &&
                            <div className='shadow absolute top-[30px] right-0 z-10 w-[360px]'>
                                <div className='bg-secondary py-5 px-5'>
                                    <div className='flex items-center'>
                                        ...
                                        <div className='ml-5 mr-[78px]'>
                                            <p className='text-black text-sm font-bold font-dm'>Black Smart Watch</p>
                                            <p className='text-black text-sm font-bold font-dm'>$44.00</p>
                                        </div>
                                        <div>
                                ...
                                <div className='bg-[#FFFFFF]'>
                                    <div>
                                        <p className='font-dm text-base text-primary py-[14px] pl-[21px]'>Subtotal: <span className='text-[#262626] font-bold'>$44.00</span></p>
                                    </div>
                                    <div className='py-5 px-[22px] gap-x-5 flex'>
                                        <div>
                                            <button className='bg-white py-4 px-[38px] font-dm font-bold text-sm border-2 border-black'>View Cart</button>
                                        </div>
                                        <div>
                                            <button className='bg-[#262626] font-dm text-sm font-bold py-4 pl-[43px] pr-[39px] text-white'>Checkout</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
