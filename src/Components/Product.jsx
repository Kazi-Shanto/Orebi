    ...
    return (
        <div>
            ...
            <div className='relative overflow-y-hidden group'>
                ...
                <NewBadge />
                <div className='absolute bottom-[-156px] group-hover:bottom-0 duration-300 bg-[#fff]/75 w-[370px] h-[156px] pr-8 pt-8'>
                    <div className='flex justify-end gap-x-[17px] items-center'>
                        <div>
                            <p className='text-base font-dm text-primary'>Add to Wish List</p>
                        </div>
                        <div>
                            ...
                            <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Icon_heart">
                                    <path id="Path" d="M12.3822 0.844553C10.9176 -0.403554 8.73939 -0.179055 7.39507 1.20803L6.86857 1.75057L6.34206 1.20803C5.00041 -0.179055 2.81957 -0.403554 1.35498 0.844553C-0.323416 2.27707 -0.411612 4.84812 1.09039 6.4009L6.26188 11.7408C6.59596 12.0855 7.1385 12.0855 7.47257 11.7408L12.6441 6.4009C14.1487 4.84812 14.0605 2.27707 12.3822 0.844553Z" fill="#262626" />
                                </g>
                            </svg>
                    ...
                    <div className='flex my-5 justify-end gap-x-[17px] items-center'>
                        <div>
                            <p className='text-base font-dm text-primary'>Compare</p>
                        </div>
                        <div>
                    ...
                    <div className='flex justify-end gap-x-[17px] items-center'>
                        <div>
                            <p className='text-base font-dm text-third font-bold'>Add to Cart</p>
                        </div>
                        <div>
            ...
            <div className='w-[370px]'>
                <div className='flex items-center justify-between my-4'>
                    <h3 className='text-third font-dm font-bold text-xl'>Basic Crew Neck Tee</h3>
                    <p className='text-base text-primary font-dm'>$44.00</p>
                </div>
                <div>
                    <p className='text-primary font-dm text-base'>Black</p>
                </div>
            </div>
        </div>
    )
